...
class Postmark(models.Model):
    ...
    def __str__(self):
        return "Postmark for " + self.location.town_city + ", " + self.location.country + ", dated " + str(self.date)
...
class Image(models.Model):
    ...
    postcard = models.ForeignKey(Object, on_delete=models.CASCADE, related_name='images', null=True)
